...
#one-col-entry(
  content: [Senior SDET with 4+ years of experience designing and implementing robust, Python-based test automation frameworks. Deep expertise in Pytest and Selenium, with a strong architectural foundation readily adaptable to keyword-driven frameworks like Robot Framework. Proven ability to lead testing initiatives, mentor team members, and drive process improvements within Agile, CI\/CD environments to ensure superior software quality and reliability.]
)
...
#one-col-entry(
  content: [#strong[Technical:] Python, Pytest, Robot Framework \(proficient in underlying keyword-driven principles\), Selenium, API Testing \(Postman, Newman\), CI\/CD Pipelines \(GitHub Actions, Jenkins\), Git, Bitbucket, SQL, JIRA, JavaScript]
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [#strong[Other:] Test Strategy & Framework Design, Test Automation Best Practices, Agile Methodologies \(Scrum\), Leadership & Mentoring, Defect Lifecycle Management, Cross-functional Collaboration]
)
...
#v(-design-text-leading)  #v(design-highlights-top-margin);#highlights([Designed, developed, and maintained a scalable Python-based UI test automation framework using Pytest and Selenium, reducing manual regression testing time by over 70\%.],[Architected and implemented automated REST API test suites using Postman–Newman, fully integrated into the CI\/CD pipeline \(GitHub Actions\) to validate every code merge and deployment.],[Led test strategy planning and collaborated with cross-functional teams to translate business requirements into comprehensive and effective automated test cases.],[Enhanced the CI\/CD process by incorporating automated failure alerts and deployment rollback triggers based on smoke test results, significantly improving release stability.],[Developed and executed performance test scripts using Locust, providing critical insights into system bottlenecks and ensuring application scalability under load.],)
  ],
)
...
#v(-design-text-leading)  #v(design-highlights-top-margin);#highlights([Demonstrated leadership capability by mentoring junior SDETs on test automation fundamentals, Python best practices, and framework architecture, fostering team skill development.],[Continuously improved the test automation framework by implementing reusable components and a Page Object Model \(POM\), increasing script efficiency and maintainability by 30\%.],[Played a key role in bug identification and tracking within an Agile \(Scrum\) workflow, using JIRA to create detailed defect reports and dashboards for stakeholder visibility.],[Designed and documented comprehensive test strategies and plans for new feature releases, ensuring alignment with the software development lifecycle \(SDLC\).],)
  ],
)
...
#one-col-entry(
  content: [
    #v(design-highlights-top-margin);#highlights([Received intensive training in core automation technologies including Python, Selenium, and BDD principles within an Agile context.],[Contributed to client projects by assisting in test planning, manual test case design, and execution, quickly applying learned automation concepts.],)
  ],
)
