...
#one-col-entry(
  content: [Accomplished and self-driven SDET with comprehensive experience in designing and implementing robust automation frameworks for UI, API, and performance testing. Proven ability to excel across the full testing spectrum, including functional, integration, system, and regression testing in fast-paced Agile environments. Expert in Python, Selenium, Pytest, and CI\/CD integration, with a strong focus on delivering high-quality products and enhancing release stability.]
)
...
#one-col-entry(
  content: [#strong[Technical:] Python, JavaScript, Selenium, Playwright, Pytest, API Testing \(Postman, Newman\), Performance Testing \(Locust\), SQL, CI\/CD \(GitHub Actions, Jenkins\), Git \(GitHub, Bitbucket\), Linux\/Unix, Bash, JIRA, New Relic]
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [#strong[QA Expertise:] Test Automation Framework Design, API & UI Testing, Performance & Load Testing, Functional Testing, System Testing, Integration Testing, Regression Testing, Agile Methodologies, Defect Management, Test Strategy & Planning]
)
...
#v(-design-text-leading)  #v(design-highlights-top-margin);#highlights([Led the design and implementation of REST API test suites using Postman-Newman, achieving 95\% endpoint coverage and integrating into GitHub Actions to validate every code merge and deployment.],[Enhanced release stability by 40\% by architecting a CI\/CD pipeline with automated MS Teams failure alerts, test artifact publishing, and a smoke-test-driven deployment rollback mechanism.],[Architected and maintained a scalable Web UI automation framework using Python, Selenium, and Pytest, reducing manual regression testing effort by over 70\%.],[Engineered and executed distributed load tests using Locust and Python on AWS, identifying and reporting critical performance bottlenecks to stakeholders using New Relic monitoring.],[Proactively drove testing strategy and planning, working independently to clarify requirements with stakeholders and executing PoCs to ensure alignment with business objectives in a fast-paced environment.],)
  ],
)
...
#v(-design-text-leading)  #v(design-highlights-top-margin);#highlights([Designed and executed detailed test plans for functional, integration, and system testing of high-impact product features within a fast-paced Agile workflow.],[Played a key role in bug lifecycle management, creating detailed execution and defect dashboards in JIRA that improved visibility for major releases.],[Executed complex end-to-end and regression tests for a critical legacy-to-microservices migration project, ensuring seamless functionality post-transition.],[Mentored junior engineers on product architecture and test automation best practices, conducting rigorous code reviews to maintain high-quality standards.],[Optimized automation codebase by implementing reusable page objects and utility functions, improving script maintainability and reducing execution time by 30\%.],)
  ],
)
